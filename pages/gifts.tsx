...
const Recommendations = () =>{
    ...
    return(
        <div className="flex-row flex w-full p-6 h-[92vh]">
            
            <div className="w-1/4  ">
                <h3 className="text-xl">Suggestions for <span className="text-[#354b6d] font-semibold">Recipient</span>.</h3>
                <h4 className='mt-8'>Sort by :</h4>
