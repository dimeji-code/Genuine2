    ...
    <div className="flex flex-col bg-[#ade3ad] px-[10%] py-4  flex-4/5    ">
        ...
        <div className='h-3/5 my-3'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
                ...
                <div className='mx-2'>
                    <img alt="..." src="/filter2.png" className="w-1/5"/>
                    <h4 className='text-xl md:text-3xl my-2'>Sorting</h4>
                    <hr className="border-t-2 rounded-md my-5 border-t-black"></hr>
                ...
                <div className='mx-2'>
                    <img alt="..." src="/delete2.png" className="w-1/5"/>
                ...
                <div className='mx-2'>
                    <img alt="..." src="/random2.png" className="w-1/5"/>
                    <h4 className='text-xl md:text-3xl my-2'>Randomization</h4>
                    <hr className="border-t-2 rounded-md my-5 border-t-black"></hr>
        ...
        <div className='h-3/5 my-3'>
            ...
            <div className='grid grid-cols-2 gap-4'>
                <div className='mx-2'>
                    <h4 className='text-xl md:text-3xl my-2'>Current</h4>
                    <hr className="border-t-2 rounded-md my-5 border-t-black"></hr>
                ...
                <div className='mx-2'>
                    <h4 className='text-xl md:text-3xl my-2'>V1</h4>
                    <hr className="border-t-2 rounded-md my-5 border-t-black"></hr>
